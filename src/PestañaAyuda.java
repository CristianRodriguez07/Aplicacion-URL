...
public class PestañaAyuda extends JFrame {
    ...
    public PestañaAyuda() {
        ...
        JLabel lblNewLabel = new JLabel("<html><body> <p>En esta pestaña se ejecuta el</p><p>comando Ping de la URL introducida.</p><br>"
        ...
        JLabel lblNewLabel_4 = new JLabel("<html><body> <p>En esta pestaña se ejecuta el</p><p>comando Tracert de la URL introducida.</p><br>"
        ...
        JLabel lblNewLabel_3 = new JLabel("<html><body> <p>En esta pestaña se ejecuta el</p><p>comando Nslookup de la URL introducida.</p><br>"
        ...
        JLabel lblNewLabel_2 = new JLabel("<html><body> <p>En esta pestaña se ejecuta el</p><p>comando Curl de la URL introducida.</p><br>"
        ...
        JLabel lblNewLabel_1 = new JLabel("<html><body> <p>En esta pestaña se ejecuta el</p><p>comando Telnet de la URL introducida.</p><br>"
